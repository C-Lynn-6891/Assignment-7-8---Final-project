...
namespace Assignment_7___8___StreetFighter_Game
{
    public partial class Form1 : Form
    {
        ...
        private void KeyIsUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.A && !playingAction && !goLeft)
            {
            ...
            if ((e.KeyCode == Keys.D && !playingAction && !goLeft && !goRight))
            {
        ...
        private void SetUpAnimation()
        {
            ...
            FrameDimension dimension = new FrameDimension(player.FrameDimensionsList[0]);
            totalFrame = player.GetFrameCount(dimension);
        ...
        private void MovePlayerandBackground()
        {
            ...
            if (goRight)
            {
                ...
                if (backgroundPosition + background.Width > this.ClientSize.Width)
                {
                    backgroundPosition -= 5;
                    drumX -= 5;
                }
        ...
        private bool DetectCollision(int object1X, int object1Y, int object1Width, int object1Heith, int object2X, int object2Y, int object2Width, int object2Height)
        {
            if (object1X + object1Width <= object2X || object1X >= object2X + object2Width || object1Y + object1Heith <= object2Y || object1Y >= object2Y + object2Height)
            {
                return false; 
            }
            else
